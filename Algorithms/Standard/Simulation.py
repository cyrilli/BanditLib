...
from EpsilonGreedyLinearBandit import EpsilonGreedyLinearBandit
...
class simulateOnlineData(object):
    ...
    def runAlgorithms(self, algorithms):
        ...
        if (self.plot==True): # only plot
            ...
            plt.savefig(os.path.join(save_address, 'CumRegretOverTime' + str(timeRun) + '.png'))
            plt.show()
...
if __name__ == '__main__':
    ...
    for i in articles:
        print(i.featureVector)
    for u in users:
        print(u.theta)
    simulation_signature = 'contextdim' + str(context_dimension) + '_' + 'actionset' + 'actionset'
