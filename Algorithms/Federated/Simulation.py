...
from FederatedEnv import UserManager, ArticleManager

from AsyncLinUCB import AsyncLinUCB
...
if __name__ == '__main__':
    ...
    simulation_signature = 'T' + str(config["testing_iterations"]) + '_' + 'n' + str(config["n_users"]) + '_' + 'contextdim' + str(config["context_dimension"]) + '_' + 'globaldim' + str(config["global_dim"])
