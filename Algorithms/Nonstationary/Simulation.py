...
from NonstationaryEnv import UserManager, ArticleManager
# Import Bandit algorithms
from AdaptiveThompson import AdaptiveThompson
from dLinUCB import dLinUCB
from oracleLinUCB import oracleLinUCB
from CoDBand import CoDBand
...
if __name__ == '__main__':
    ...
    algorithms['DenBand'] = DenBand(dimension=config["context_dimension"], alpha=config["dLinUCB_alpha"],
                                    ...
                                    delta_1=config["delta_1"], delta_2=config["delta_2"], 
                                    tilde_delta_1=config["tilde_delta_1"],
                                    delta_L=config["tilde_delta_1"],age_threshold=config["testing_iterations"]/2)
