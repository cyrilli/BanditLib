...
class CoDBand:
    ...
    def construct_from_param_dict(cls, param_dict):
        return cls(v=param_dict["v"], d=param_dict["dimension"], lambda_=param_dict["lambda_"], NoiseScale=param_dict["NoiseScale"], alpha_prior=param_dict["alpha_prior"], tau_cd=param_dict["tau_cd"], 
                    memory_size=param_dict["memory_size"], alpha=param_dict["alpha"], delta_1 = 1e-2 , delta_2 = 1e-1, eta=0.3, disable_change_detector=False, true_alpha_0 = None)
